...
{
    public class HarvesterBuilding : CustomBuilding
    {
        ...
        public override void Update(GameTime time)
        {
            ...
            if (this.junimoSendOutTimer > 0 || this.myJunimos.Count<JunimoHarvester>() >= this.MaxHarvesters || (Game1.IsWinter || Game1.isRaining) || (!this.areThereMatureCropsWithinRadius() || Game1.farmEvent != null))
                return;
            Harvester junimoHarvester = new Harvester(new Vector2((float)(this.tileX + 1), (float)(this.tileY + 1)) * (float)Game1.tileSize + new Vector2(0.0f, (float)(Game1.tileSize / 2)), this, this.getUnusedJunimoNumber());
